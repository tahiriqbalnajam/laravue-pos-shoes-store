...
export const asyncRoutes = [
  {
    ...
    meta: { permissions: ['view menu products'] },
    children: [
      {
        path: 'index',
        component: () => import('@/views/product/product_index'),
        name: 'Products',
        meta: { title: 'Products', icon: 'excel', noCache: true },
      },
      {
        hidden: true,
        path: 'createvariable',
        component: () => import('@/views/product/product_create_variable'),
        name: 'Create Product',
        meta: { title: 'Create Variable Product', icon: 'documentation', noCache: true, visible: false },
      },
      {
        hidden: true,
        path: 'create',
        component: () => import('@/views/product/product_create'),
        name: 'Create Product',
        meta: { title: 'Create Product', icon: 'documentation', noCache: true, visible: false },
      },
      {
        hidden: true,
        path: 'edit/:id(\\d+)',
        component: () => import('@/views/product/product_edit'),
        name: 'Edit Product',
        meta: { title: 'Edit Product', icon: 'documentation', noCache: true, visible: false },
      },
      {
        hidden: true,
        path: 'import',
        ...
        meta: { title: 'Import Products', icon: 'documentation', noCache: true, visible: false },
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      {
        path: 'index',
        component: () => import('@/views/purchase/purchase_index'),
        name: 'Purchase',
        meta: { title: 'Purchase', icon: 'money', noCache: true },
      },
    ],
  },
  {
    ...
    children: [
      {
        path: 'index',
        component: () => import('@/views/outlet/index'),
        name: 'Outlet',
        meta: { title: 'Outlet', icon: 'documentation', noCache: true },
      },
    ],
  },
  {
    ...
    children: [
      ...
      {
        path: 'transactions',
        component: () => import('@/views/accounts/transactions'),
        name: 'Transactions',
        meta: { title: 'Transactions', icon: 'el-icon-s-finance', noCache: true },
      },
      {
        path: 'manufacturer',
        component: () => import('@/views/accounts/Manufactuer'),
        name: 'Manufacturers',
        meta: { title: 'Manufacturers', icon: 'el-icon-s-finance', noCache: true },
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        name: 'Reports',
        meta: { title: 'Sale Reports', icon: 'star', noCache: true },
      },
      {
        path: 'purchase_report',
        component: () => import('@/views/reports/purchase_report'),
        name: 'Purchase Reports',
        meta: { title: 'Purchase Reports', icon: 'shopping', noCache: true },
      },
      {
        path: 'print_report',
        component: () => import('@/views/reports/StockReport'),
        name: 'Today Reports',
        meta: { title: 'Today Product Sale', icon: 'list', noCache: true },
      },
      {
        path: 'udhar_report',
        component: () => import('@/views/reports/UdharReport'),
        name: 'Udhar Reports',
        meta: { title: 'Udhar Report', icon: 'excel', noCache: true },
      },
      {
        path: 'stock_value',
  ...
  },
  {
    ...
    children: [
      {
        path: 'index',
        component: () => import('@/views/settings/setting_index'),
        name: 'Settings',
